...
<html lang="en">
<head>
  <title>Buku Tamu learninghtml</title>
  <meta charset="utf-8">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="Tentang saya.php">Tentang kami</a></li>
...
<div class="container">
 ...
 <br>
            ...
            <div class="col-md-8">
                ...
                <form action="buku_tamu/simpanBukuTamu.php" role="form" method="post" name="frmBukuTamu">  <!-- Method post untuk mengirim nilai inputan variabel ke databese -->
                  ...
                  <div class="form-group">
                    ...
                    &nbsp &nbsp &nbsp &nbsp<input type="radio" name="kelamin" value="Laki-Laki" required> Laki-Laki
                    <br/>
                    &nbsp &nbsp &nbsp &nbsp<input type="radio" name="kelamin" value="Perempuan" required> Perempuan
                  </div>
                  <div class="form-group">
...
<br>
            ...
            <div class="col-md-4">
                ...
                <div id="search" class="well">
                    <h4>Search</h4>
                    <form action="Searching.php" method="get">   <!-- Method get untuk mengirim nilai inputan variabel ke databese -->
                      <p>
